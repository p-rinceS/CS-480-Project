    ...
    <>
      <div className={"header-container"}>
        <div className={"hello-user-text"}>
          {isUserLoggedIn && <h3>Hello, {getUserIdentifingName()}!</h3>}
        </div>
        {isUserLoggedIn && (
          <section>
            {getUserRole() === "admin" && (
            ...
            {getUserRole() === "client" && (
              <div className={"header-tabs"}>
                <button onClick={() => navigate("/")}>Home</button>
                <button onClick={() => navigate("/payment-info")}>
                  My Payment Info
                </button>
            ...
            {getUserRole() === "driver" && (
              <div className={"header-tabs"}>
                <button onClick={() => navigate("/manage-address")}>
                  Manage Address
                </button>
          ...
          {isUserLoggedIn && (
            <button
              onClick={() => {
                ...
                document.cookie =
                  "identity=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
                navigate("/login");
